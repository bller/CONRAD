    ...
    public class DefectPixelInterpolation {
    	...
    	{
    		//padding
    		Grid2DComplex G = new Grid2DComplex(image, zeroPadding); // increasing resolution in frq domain (0en anfuegen)
    		...
    		for(int i = 0; i < maxIter; i++)
    		{
    			...
    			int s2 = (s1 > 0) ? dim[0] - (s1 % dim[0]) : s1; //in case of a shift(neg values, won't happen)
    	...
    	public static void main(String[] args) {
    		...
    		String filename = "/proj/i5dmip/zi79moji/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/testimg.bmp";
    		String filenameMask = "/proj/i5dmip/zi79moji/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mask.bmp";
